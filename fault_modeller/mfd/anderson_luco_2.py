"""Module :mod: mfd.anderson_luco_2 implements class AndersonLucoType2"""
import numpy as np
from mfd.base import BaseMFDfromSlip

class AndersonLucoType2(BaseMFDfromSlip):
    '''Class to implement the 2nd fault activity rate calculator                
    ...
    def _cumulative_value(self, slip, mmax, mag_value, bbar, dbar, beta):
        # Calculate N(M > mag_value) using Anderson & Luco Type 2 formula
