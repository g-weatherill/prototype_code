# -*- coding: iso-8859-1 -*-
#
# quakepy/PrincipalAxes.py
# $Id: PrincipalAxes.py 157 2009-02-16 11:15:52Z fab $
#
# The QuakePy package
...
__version__  = '$Id: PrincipalAxes.py 157 2009-02-16 11:15:52Z fab $'
...
class PrincipalAxes( QPObject ):
    ...
    addElements = QPElementList( (
                    QPElement( 'tAxis', 'tAxis', 'element', Axis, 'complex' ),
                    QPElement( 'pAxis', 'pAxis', 'element', Axis, 'complex' ),
                    QPElement( 'nAxis', 'nAxis', 'element', Axis, 'complex' )
                  ) )
    # <!-- UML2Py end -->
