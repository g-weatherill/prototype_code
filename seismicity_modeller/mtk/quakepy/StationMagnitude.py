# -*- coding: iso-8859-1 -*-
#
# quakepy/StationMagnitude.py
# $Id: StationMagnitude.py 157 2009-02-16 11:15:52Z fab $
#
# The QuakePy package
...
__version__  = '$Id: StationMagnitude.py 157 2009-02-16 11:15:52Z fab $'
...
class StationMagnitude( QPObject ):
    """
    ...
    addElements = QPElementList( (
                    QPElement( 'id', 'id', 'element', unicode, 'basic' ),
                    QPElement( 'type', 'type', 'element', unicode, 'basic' ),
                    QPElement( 'stationAmplitudeID', 'stationAmplitudeID', 'element', unicode, 'basic' ),
    ...
    def __init__( self, **kwargs ):
        super( StationMagnitude, self ).__init__( **kwargs )
