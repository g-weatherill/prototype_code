# -*- coding: iso-8859-1 -*-
#
# quakepy/TimeQuantity.py
# $Id: TimeQuantity.py 157 2009-02-16 11:15:52Z fab $
#
# The QuakePy package
...
__version__  = '$Id: TimeQuantity.py 157 2009-02-16 11:15:52Z fab $'
...
class TimeQuantity( QPObject ):
    """
    QuakePy: TimeQuantity - value is mxDateTime
    """

    # <!-- UML2Py start -->
    addElements = QPElementList( (
                    QPElement( 'value', 'value', 'element', QPDateTime, 'basic' ),
    ...
    def __init__( self, val = None, unc = None, unc_lower = None, unc_upper = None, **kwargs ):
        """
        val can be (1) string with time in ISO format
                   (2) tuple with ( year, month, day, hour, minute, second )
                   (3) mxDateTime object
        unc, unc_lower, and unc_upper are floats
        """
        ...
        self.value            = ( val != None and [QPDateTime(val)] or [None] )[0]
