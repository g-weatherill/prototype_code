# -*- coding: iso-8859-1 -*-
#
# quakepy/TimeWindow.py
# $Id: TimeWindow.py 157 2009-02-16 11:15:52Z fab $
#
# The QuakePy package
...
__version__  = '$Id: TimeWindow.py 157 2009-02-16 11:15:52Z fab $'
...
class TimeWindow( QPObject ):
    ...
    addElements = QPElementList( (
                    QPElement( 'begin', 'begin', 'element', float, 'basic' ),
                    QPElement( 'end', 'end', 'element', float, 'basic' ),
                    QPElement( 'reference', 'reference', 'element', QPDateTime, 'basic' )
                  ) )
    # <!-- UML2Py end -->
    ...
    def __init__( self, begin = None, end = None, reference = None, **kwargs ):
        ...
        if reference is not None:
            self.reference = QPDateTime( reference )
