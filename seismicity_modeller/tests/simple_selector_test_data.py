...
simple_test = {'eventID': np.array([101, 102, 103, 104, 105, 106, 107, 108, 109, 110], dtype=int),
               ...
               'depth' : np.array([5., 10., 5., 10., 5., 10., 5., 10., 5., 10.]),
               'magnitude': np.array([4., 4.5, 4.7,  5., 5.5, 6., 6.5, 6.8, 7., 7.5]),
               'xyz': None}